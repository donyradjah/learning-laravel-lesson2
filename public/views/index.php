...
<!--[if lt IE 7]>
<html class="lt-ie7" data-ng-src="ConApp" ng-class="{'rtl': settings.rtl}"> <![endif]-->
<!--[if IE 7]>
<html class="lt-ie8" data-ng-src="ConApp" ng-class="{'rtl': settings.rtl}"> <![endif]-->
<!--[if IE 8]>
<html class="lt-ie9" data-ng-src="ConApp" ng-class="{'rtl': settings.rtl}"> <![endif]-->
<!--[if gt IE 8]><!-->
<html data-ng-app="conAngular" ng-class="{'rtl': settings.rtl}"> <!--<![endif]-->
<head>
    <meta charset="utf-8">
...
-->
<div class="chat" ng-class="{'chat-light': settings.chat.light}" data-ng-include="'tpl/parts/chat.html'"
     data-ng-controller="ChatController">
</div>
<!-- /Chat -->

<!-- Footer -->
<footer>&copy; 2015 <strong>nK</strong>. All rights reserved. <a
        href="http://themeforest.net/item/con-material-admin-dashboard-template/10621512?ref=nKdev">Purchase</a>
</footer>
<!-- /Footer -->
...
<script src="../src/user/user.js" type="text/javascript"></script>
<script src="../src/user/user-list-service.js" type="text/javascript"></script>
